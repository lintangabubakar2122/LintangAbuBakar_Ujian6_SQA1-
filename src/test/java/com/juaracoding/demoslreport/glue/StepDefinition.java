package com.juaracoding.demoslreport.glue;
...
import com.juaracoding.demoslreport.config.AutomationFrameworkConfiguration;
import com.juaracoding.demoslreport.driver.DriverSingleton;
import com.juaracoding.demoslreport.page.CartPage;
import com.juaracoding.demoslreport.page.CheckoutPage;
import com.juaracoding.demoslreport.page.LoginPage;
import com.juaracoding.demoslreport.page.RegisterPage;
import com.juaracoding.demoslreport.utils.ConfigurationProperties;
import com.juaracoding.demoslreport.utils.Constants;
import com.juaracoding.demoslreport.utils.TestCases;
import com.juaracoding.demoslreport.utils.Utils;
...
//		assertThat(configurationProperties.getMesslogin(), containsString(loginPage.getMess()));
	...
	public void User_click_shoptools_button() {
		cartPage.goToClothes();
		extentTest.log(LogStatus.PASS, "User click shoptools button");
	}
	
	@And("^User choose clothes colour size and click add to cart")
	public void And_User_choose_clothes_colour_size_and_click_add_to_cart() {
		cartPage.Clothes();
		cartPage.ColorClothes(1);
		cartPage.SizeClothes(1);
		extentTest.log(LogStatus.PASS, "User choose clothes colour size and click add to cart");
	}
